...
async def create_user(user: UserCreate):
    ...
    try:
        ...
        return UserResponse(**db_user.__dict__, shard_name=shard_name)
...
async def get_user(user_id: int):
    ...
    for shard_name in session_manager.sessions.keys():
        ...
        if user:
            ...
            return UserResponse(**user.__dict__, shard_name=shard_name)
...
async def get_users_by_shard_key(shard_key: str):
    ...
    return [UserResponse(**user.__dict__, shard_name=shard_name) for user in users]
